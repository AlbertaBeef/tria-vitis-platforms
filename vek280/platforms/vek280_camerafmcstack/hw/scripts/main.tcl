...
set proj_name vek280_camerafmcstack
#set proj_board [get_board_parts xilinx.com:vek280_es_revb:part0:1.0]
set proj_board [get_board_parts xilinx.com:vek280:part0:* -latest_file_version]
...
set xdc_list {xdc/mipi_vek280.xdc xdc/hdmi_tx_vek280.xdc xdc/default.xdc}
set ip_repo_path {./ip}
...
source $bd_tcl_dir/vek280_camerafmcstack.tcl
save_bd_design
