...
################################################################
# This is a generated script based on design: uz7ev_evcc_hdmi
#
...
# source uz7ev_evcc_hdmi_script.tcl
...
set design_name uz7ev_evcc_hdmi
...
\
  ...
  connect_bd_net -net Net [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_rx/v_frmbuf_wr_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xB0080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_rx/v_proc_ss_0/s_axi_ctrl/Reg] -force
  ...
  set_property PFM_NAME {tria-technologies.com:uz7ev:uz7ev_evcc_hdmi:1.0} [get_files [current_bd_design].bd]
  ...
  set_property PFM.AXI_PORT {  M09_AXI {memport "M_AXI_GP" sptag "HPM0_FPD" memory ""}  M10_AXI {memport "M_AXI_GP" sptag "HPM0_FPD" memory ""}  M11_AXI {memport "M_AXI_GP" sptag "HPM0_FPD" memory ""}  M12_AXI {memport "M_AXI_GP" sptag "HPM0_FPD" memory ""}  M13_AXI {memport "M_AXI_GP" sptag "HPM0_FPD" memory ""}  M14_AXI {memport "M_AXI_GP" sptag "HPM0_FPD" memory ""}  M15_AXI {memport "M_AXI_GP" sptag "HPM0_FPD" memory ""}  M16_AXI {memport "M_AXI_GP" sptag "HPM0_FPD" memory ""}  } [get_bd_cells /ps8_0_axi_periph]
