...
################################################################
# This is a generated script based on design: ved2302_rpiRx2l2_hdmiTx
#
...
# source ved2302_rpiRx2l2_hdmiTx_script.tcl
...
set design_name ved2302_rpiRx2l2_hdmiTx
...
proc create_hier_cell_hdmiphy_ss { parentCell nameHier } {
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/hdmiphy_ss/gt_quad_base/TX0_GT_IP_Interface ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_tx./hdmiphy_ss/hdmi_gt_controller_0/gt_tx0.0 /hdmiphy_ss/gt_quad_base/TX1_GT_IP_Interface\
ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_tx./hdmiphy_ss/hdmi_gt_controller_0/gt_tx1.1 /hdmiphy_ss/gt_quad_base/TX2_GT_IP_Interface ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_tx./hdmiphy_ss/hdmi_gt_controller_0/gt_tx2.2\
/hdmiphy_ss/gt_quad_base/TX3_GT_IP_Interface ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_tx./hdmiphy_ss/hdmi_gt_controller_0/gt_tx3.3 /hdmiphy_ss/gt_quad_base/RX0_GT_IP_Interface ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_rx./hdmiphy_ss/hdmi_gt_controller_0/gt_rx0.0\
/hdmiphy_ss/gt_quad_base/RX1_GT_IP_Interface ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_rx./hdmiphy_ss/hdmi_gt_controller_0/gt_rx1.1 /hdmiphy_ss/gt_quad_base/RX2_GT_IP_Interface ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_rx./hdmiphy_ss/hdmi_gt_controller_0/gt_rx2.2\
/hdmiphy_ss/gt_quad_base/RX3_GT_IP_Interface ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_rx./hdmiphy_ss/hdmi_gt_controller_0/gt_rx3.3} \
    CONFIG.GT_TYPE {GTYP} \
...
false TX_BUFFER_RESET_ON_RATE_CHANGE ENABLE GT_TYPE GTYP} \
    ...
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/hdmiphy_ss/gt_quad_base {/hdmiphy_ss/gt_quad_base ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_tx.IP_CH0,ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_tx.IP_CH1,ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_tx.IP_CH2,ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_tx.IP_CH3\
MSTRCLK 1,0,0,0 IS_CURRENT_QUAD 1}} RX_QUAD_CH {RXQuad_0_/hdmiphy_ss/gt_quad_base {/hdmiphy_ss/gt_quad_base ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_rx.IP_CH0,ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_rx.IP_CH1,ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_rx.IP_CH2,ved2302_4rpiRx_hdmiTx_hdmi_gt_controller_0_0_rx.IP_CH3\
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins cips_ss_0/gpio_io_o] [get_bd_pins mipi_0/Din] [get_bd_pins mipi_1/Din]
  ...
  connect_bd_net -net dphy_clk_200M_1 [get_bd_pins cips_ss_0/clk_200M] [get_bd_pins mipi_0/dphy_clk_200M] [get_bd_pins mipi_1/dphy_clk_200M]
  connect_bd_net -net fbrd_irq3_1 [get_bd_pins hdmi/interrupt] [get_bd_pins cips_ss_0/fbrd_irq2]
  ...
  connect_bd_net -net net_cips_ss_0_clk_out2 [get_bd_pins cips_ss_0/clk_250M] [get_bd_pins cips_noc/aclk5] [get_bd_pins mipi_0/video_aclk] [get_bd_pins mipi_1/video_aclk] [get_bd_pins smartconnect_mipi2/aclk] [get_bd_pins smartconnect_mipi5/aclk] [get_bd_pins smartconnect_mipi6/aclk] [get_bd_pins smartconnect_mipi9/aclk]
  connect_bd_net -net net_cips_ss_0_dcm_locked [get_bd_pins cips_ss_0/peripheral_aresetn_250M] [get_bd_pins mipi_0/video_aresetn] [get_bd_pins mipi_1/video_aresetn] [get_bd_pins smartconnect_mipi2/aresetn] [get_bd_pins smartconnect_mipi5/aresetn] [get_bd_pins smartconnect_mipi6/aresetn] [get_bd_pins smartconnect_mipi9/aresetn]
  connect_bd_net -net net_cips_ss_0_frl_clk [get_bd_pins cips_ss_0/frl_clk] [get_bd_pins hdmi/frl_clk]
  connect_bd_net -net net_cips_ss_0_peripheral_aresetn [get_bd_pins cips_ss_0/peripheral_aresetn_100M] [get_bd_pins hdmi/s_axis_audio_aresetn] [get_bd_pins hdmiphy_ss/vid_phy_axi4lite_aresetn] [get_bd_pins hdmiphy_ss/vid_phy_sb_aresetn] [get_bd_pins mipi_0/lite_aresetn] [get_bd_pins mipi_1/lite_aresetn]
  connect_bd_net -net net_cips_ss_0_s_axi_aclk [get_bd_pins cips_ss_0/s_axi_aclk] [get_bd_pins ConfigNoc/aclk5] [get_bd_pins hdmi/s_axis_audio_aclk] [get_bd_pins hdmiphy_ss/drp_clk] [get_bd_pins hdmiphy_ss/vid_phy_axi4lite_aclk] [get_bd_pins hdmiphy_ss/vid_phy_sb_aclk] [get_bd_pins mipi_0/lite_aclk] [get_bd_pins mipi_1/lite_aclk]
  ...
  set_property PFM_NAME {tria-technologies.com:ved2302_iocc:ved2302_rpiRx2l2_hdmiTx:1.0} [get_files [current_bd_design].bd]
